...
// passwordResetContent arma el asunto y el cuerpo HTML del correo de restablecimiento.
// Lo comparten las implementaciones de EmailService (SMTP local / SES en la nube).
func passwordResetContent(frontendURL, resetToken string) (subject, htmlBody string) {
